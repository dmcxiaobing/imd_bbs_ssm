                ...
                <div class="mdl-cell mdl-cell--4-col">
                    <div class="mdl-card mdl-shadow--2dp center">
                        ...
                        <div class="mdl-card__subtitle-text">
                            <form name="updateUserInfo" action="${pageContext.request.contextPath}/user/updateUserInfo" method="post">
                                <table class="mdl-data-table mdl-js-data-table mdl-data-table--selectable mdl-shadow--2dp">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div align="left">
                                                <a href="${pageContext.request.contextPath}/" class="mdl-button mdl-js-button mdl-button--raised">返回首页</a>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
