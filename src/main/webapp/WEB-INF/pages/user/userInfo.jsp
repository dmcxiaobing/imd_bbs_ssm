...
<div class="mdl-layout mdl-js-layout">
    <header class="mdl-layout__header mdl-layout__header--scroll mdl-color--grey-50">
        <div class="mdl-layout__header-row">
            <!-- Title -->
            <a class="mdl-layout-title mdl-navigation__link mdl-color-text--pink-400" href="${pageContext.request.contextPath}/main">Excited</a>
                        ...
                        <div class="mdl-card__subtitle-text">
                            <table class="mdl-data-table mdl-js-data-table mdl-data-table--selectable mdl-shadow--2dp"
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href="${pageContext.request.contextPath}/main" class="mdl-button mdl-js-button mdl-button--raised">
                                            返回
                                        </a>
                                    </td>
                                </tr>
