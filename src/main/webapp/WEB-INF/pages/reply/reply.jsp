            ...
            <nav class="mdl-navigation">
                <c:choose>
                    <c:when test="${username != null}">
                        <a href="${pageContext.request.contextPath}/user/listUserInfo?username=${username}" class="mdl-navigation__link mdl-color-text--pink-400">
                                ${username}
                        </a>
                        <c:if test="${username == 'admin'}">
                            <a href="${pageContext.request.contextPath}/admin/manageCenter" class="mdl-navigation__link mdl-color-text--black">登入管理后台</a>
                        </c:if>
                        <a href="${pageContext.request.contextPath}/user/loginOut" class="mdl-navigation__link mdl-color-text--black">注销</a>
                    </c:when>
                    <c:when test="${username == null}">
