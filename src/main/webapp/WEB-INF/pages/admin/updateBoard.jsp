        ...
        <div class="page-content">
            ...
            <div class="mdl-grid">
                ...
                <div class="mdl-cell--4-col">
                    <form action="${pageContext.request.contextPath}/admin/updateBoard" method="post">
                            ...
                            <tr>
                                <td>
                                    <a class="mdl-button mdl-js-button mdl-button--raised mdl-color--pink-400 mdl-color-text--white"
                                       href="${pageContext.request.contextPath}/admin/updateBoard" type="submit" name="submit">修改</a>
                                </td>
                                <td>
