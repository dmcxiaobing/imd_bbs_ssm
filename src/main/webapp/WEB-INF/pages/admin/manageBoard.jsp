    ...
    <header class="mdl-layout__header mdl-layout__header--scroll mdl-color--grey-50">
        <div class="mdl-layout__header-row">
            ...
            <nav class="mdl-navigation">
                ...
                <a class="mdl-navigation__link mdl-color-text--black" href="${pageContext.request.contextPath}/addBoard">添加板块</a>
            </nav>
        </div>
    </header>
                        ...
                        <table class="mdl-data-table mdl-js-data-table mdl-data-table--selectable mdl-shadow--2dp center card-width"
                            ...
                            <tr>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <div align="right">
                                        <a href="${pageContext.request.contextPath}/updateBoardPage?boardId=${boards.boardId}"
                                           class="mdl-button mdl-js-button mdl-color-text--pink-400">修改</a>
                                    </div>
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <div align="right">
                                        <a href="${pageContext.request.contextPath}/admin/deleteBoard?boardId=${boards.boardId}"
